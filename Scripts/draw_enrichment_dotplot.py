...
up_file = "/BiO/Research/FlapnoserayTumorTranscriptome/Results/7_go/diff_expressed_tumor_normal_upreg.GOseq.enriched"
down_file = "/BiO/Research/FlapnoserayTumorTranscriptome/Results/7_go/diff_expressed_tumor_normal_downreg.GOseq.enriched"
...
df_up_top = prepare_df(dict_up_bp, "BP", top=10)
df_up_all = prepare_df(dict_up_bp, "BP", top=None)
df_down_top = prepare_df(dict_down_bp, "BP", top=10)
...
axs[0].legend(handles=legend_dots, title='-log10(qVal.)', bbox_to_anchor=(1.05, 0.5), frameon=False)
axs[1].legend(handles=legend_dots, title='-log10(qVal.)', bbox_to_anchor=(1.05, 0.5), frameon=False)
...
# %%
path_enrichment_upregulated_genes = "/BiO/Research/FlapnoserayTumorTranscriptome/Results/7_go/enrichment_upregulated_terms.xlsx"
path_enrichment_downregulated_genes = "/BiO/Research/FlapnoserayTumorTranscriptome/Results/7_go/enrichment_downregulated_terms.xlsx"
df_up_all.to_excel(path_enrichment_upregulated_genes)
df_down_all.to_excel(path_enrichment_downregulated_genes)

# %%
path_obo = "/BiO/Research/FlapnoserayTumorTranscriptome/Resources/Data/Database/go-basic.obo"
...
plt.savefig("/BiO/Research/FlapnoserayTumorTranscriptome/Results/7_go/enrichment.png", dpi=300)
plt.show()
plt.close()
